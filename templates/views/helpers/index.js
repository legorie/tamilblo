...
module.exports = function () {
	...
	* */
	...
	// Compare function to perform the classic if stmt
	_helpers.compare = function (lvalue, operator, rvalue, options) {
	...
	_helpers.printo = function(optionalValue) {
	...
	_helpers.breaklines = function(text) {
